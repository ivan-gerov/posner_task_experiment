...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\Data Science and Coding\\Python\\Studying\\Final Year Project\\sounds\\sounds.py',
...
def sounds_routine():
    ...
    conditionList = [{'sounds': 'lofi/happy.wav'}, 
                     {'sounds':'lofi/buddy.wav'}]
